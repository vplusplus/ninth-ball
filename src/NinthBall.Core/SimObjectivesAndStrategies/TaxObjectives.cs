...
namespace NinthBall.Core
{
    ...
    sealed class FlatTaxObjective(Initial Initial, ITaxSystem TheTaxSystem, FlatTax FT, TaxAndMarketAssumptions TAMA) : ISimObjective, ISimStrategy
    {
        ...
        void ISimStrategy.Apply(ISimState context)
        {
            context.Taxes = 0 == context.YearIndex
                ...
                : TheTaxSystem.GuesstimateTaxes(context.PriorYear.UnadjustedEarnings(TAMA), context.PriorYear.InflationIndex, Year0TaxRates);
        }
    ...
    [StrategyFamily(StrategyFamily.Taxes)] 
    sealed class TieredTaxObjective(Initial Initial, ITaxSystem TheTaxSystem, TaxRateSchedules Year0TaxRates, TaxAndMarketAssumptions TAMA) : ISimObjective, ISimStrategy
    {
