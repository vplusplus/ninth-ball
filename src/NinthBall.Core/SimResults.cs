...
{
    public sealed record SimResult(SimParams SimParams, InitialBalance InitialBalance, IReadOnlyList<string> Strategies, IReadOnlyList<SimIteration> Iterations);
