...
//            // SimScore10 the result with all ratings (batch operation)
//            var scoredResult = result.WithScores(problem.Ratings);

//            // Check for constraint violations (SimScore10.Zero or SimScore10.Unknown)
//            bool hasViolation = scoredResult.Scores.Values.Any(score => score <= SimScore10.Zero || score.IsUnknown);
...
//            {
//                SimScore10 aScore = a.Result.Scores[rating.Name];
//                SimScore10 bScore = b.Result.Scores[rating.Name];
